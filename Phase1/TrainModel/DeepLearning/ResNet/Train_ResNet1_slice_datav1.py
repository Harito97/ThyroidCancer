...
from tensorflow.keras.layers import Dense, Conv2D, GlobalAveragePooling2D, Input, Flatten, Dropout
...
def save_history(history):
    ...
    com.to_csv("slice_datav1_resnet1_history.csv", index=False)
...
def plot_history(history):
    ...
    plt.savefig("slice_datav1_resnet1_model_accuracy_loss.png")
    plt.show()
...
# finetuned_model.load_weights('/mnt/DataK/Project/GasHisCancer/PatchLevel_GasHisSDB/resnet_best.keras')
...
checkpointer = ModelCheckpoint(
    "resnet1_best_slice_datav1.keras",
    verbose=1,
    save_best_only=True,
)
